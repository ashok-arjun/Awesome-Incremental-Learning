...
- <a name="todo"></a> SS-IL: Separated Softmax for Incremental Learning (**ICCV, 2021**) [[paper](https://openaccess.thecvf.com/content/ICCV2021/papers/Ahn_SS-IL_Separated_Softmax_for_Incremental_Learning_ICCV_2021_paper.pdf)] --> `NI`
- <a name="todo"></a> Striking a Balance between Stability and Plasticity for Class-Incremental Learning (**ICCV, 2021**) [[paper](http://www.eecs.qmul.ac.uk/~sgg/papers/WuEtAl_ICCV2021.pdf)] - `reformulated baseline, no exemplars, uses contrastive learning and RotNet along with a simple CE and embedding loss ---> NI
...
- <a name="todo"></a> Co2L: Contrastive Continual Learning (**ICCV, 2021**) [[paper](https://openaccess.thecvf.com/content/ICCV2021/papers/Cha_Co2L_Contrastive_Continual_Learning_ICCV_2021_paper.pdf)] - `applies contrastive loss only on the current task (leaving exemplars untouched) + distills distance between instances of previous class samples`
