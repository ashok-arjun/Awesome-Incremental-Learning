...
- <a name="todo"></a> Striking a Balance between Stability and Plasticity for Class-Incremental Learning (**ICCV, 2021**) [[paper](http://www.eecs.qmul.ac.uk/~sgg/papers/WuEtAl_ICCV2021.pdf)] - `reformulated baseline, no exemplars, uses contrastive learning and RotNet along with a simple CE and embedding loss ---> NOTHING TO WORRY`
